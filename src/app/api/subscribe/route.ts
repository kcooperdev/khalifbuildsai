...
export async function POST(request: Request) {
  try {
    ...
    await resend.emails.send({
      from: "Khalif <hello@khalifbuildsai.com>",
      to: email,
      subject: "Welcome — your free AI course is ready",
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 500px; margin: 0 auto; padding: 40px 20px;">
          <h1 style="font-size: 24px; font-weight: bold; color: #111; margin-bottom: 16px;">Welcome to khalifbuildsai</h1>
          ...
          <a href="https://khalifbuildsai.com/academy/introduction-to-ai/what-is-ai" style="display: inline-block; background: #111; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">
            Start Lesson 1
          </a>
