...
export const projects: Project[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "It grew directly out of my community work in Baltimore — the same instinct behind Baltimore Tech Week, pointed at the everyday calendar instead of one big week.",
